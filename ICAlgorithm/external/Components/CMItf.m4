...
DEF_API(`void',`CDECL',`cmaddcomponent',`(cmaddcomponent_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0x3FB931A6),0x03050C1E)
...
DEF_API(`void',`CDECL',`cmaddcomponent2',`(cmaddcomponent2_struct *p)',1,0x1057D488,0x03050C1E)
...
DEF_API(`void',`CDECL',`cmexitcomponent',`(cmexitcomponent_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0x0DDC8E7F),0x03050C1E)
...
DEF_API(`void',`CDECL',`cmgetcomponentbyname',`(cmgetcomponentbyname_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0x1C90B550),0x03050C1E)
...
DEF_API(`void',`CDECL',`cminitcomponent',`(cminitcomponent_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0xAD863340),0x03050C1E)
...
DEF_API(`void',`CDECL',`cmregistergetuserlicensevalue',`(cmregistergetuserlicensevalue_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0x84364FC6),0x03050C1E)
...
DEF_API(`void',`CDECL',`cmregisterlicensefunctions',`(cmregisterlicensefunctions_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0xC18CCC88),0x03050C1E)
...
DEF_API(`void',`CDECL',`cmremovecomponent',`(cmremovecomponent_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0xB53B03F4),0x03050C1E)
...
DEF_API(`void',`CDECL',`cmshutdown',`(cmshutdown_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0x28C83A52),0x03050C1E)
...
DEF_API(`void',`CDECL',`cmunregistergetuserlicensevalue',`(cmunregistergetuserlicensevalue_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0xE400F55F),0x03050C1E)
...
DEF_API(`void',`CDECL',`cmunregisterlicensefunctions',`(cmunregisterlicensefunctions_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0x7144A275),0x03050C1E)
...
DEF_API(`void',`CDECL',`cmutlcwstrcpy',`(cmutlcwstrcpy_struct *p)',1,RTSITF_GET_SIGNATURE(0x09DB4923, 0xCCB6DDB5),0x03050C1E)
...
DEF_API(`void',`CDECL',`cmutlsafestrcpy',`(cmutlsafestrcpy_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0x794C4461),0x03050C1E)
...
DEF_API(`void',`CDECL',`cmutlstricmp',`(cmutlstricmp_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0xF3161529),0x03050C1E)
...
DEF_API(`void',`CDECL',`cmutlutf8tow',`(cmutlutf8tow_struct *p)',1,RTSITF_GET_SIGNATURE(0xB78A45E0, 0x76EB6470),0x03050C1E)
...
DEF_API(`void',`CDECL',`cmutlwstrcpy',`(cmutlwstrcpy_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0x92BF32B1),0x03050C1E)
...
DEF_API(`void',`CDECL',`cmutlwtoutf8',`(cmutlwtoutf8_struct *p)',1,RTSITF_GET_SIGNATURE(0xAE6E95C8, 0x61F1F05D),0x03050C1E)
